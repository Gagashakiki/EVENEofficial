        ...
        <div class="col-12">
          <div class="btn-group" role="group" aria-label="...">
            @if(session()->get('profil')[0]->jenis == 'vendor')
              <a href="{{ url('/myvendors') }}" class="btn btn-default"><i class="fa fa-th" aria-hidden="true"></i>My
                Vendors</a>
            @endif
                ...
                <div class="row">
                  ...
                  <div class="col-md-8 col-lg-9 col-xl-10 col-12">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-7">
                        <input type="text" name="nama1" value="{{$user->nama1}}" class="form-control" id=""
                               placeholder="Mr.">
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-md-7">
                        <input type="text" name="nama2" class="form-control" value="{{$user->nama2}}" id=""
                               placeholder="Name">
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" name="notelp" class="form-control" value="{{$user->notelp}}" id=""
                               placeholder="841 8329 8138">
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        ...
                        <input style="position:absolute; right:5%; top:15%;" type="button" onclick="showpass1()"
                               value="Show" id="showpass">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="" class="col-md-3 control-label">New Password</label>
                      <div class="col-md-9">
                        <input type="password" name="passnew" class="form-control" id="confpass"
                               placeholder="***********">
                        <input style="position:absolute; right:5%; top:15%;" type="button" onclick="showpassc()"
                               value="Show" id="showpass2">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class=" col-md-12 ">
