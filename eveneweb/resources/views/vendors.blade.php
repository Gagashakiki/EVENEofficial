                ...
                <ul class="nav navbar-nav side-nav">
                  <li>
                    ...
                    <ul id="event" class="collapse collapseItem show">
                      ...
                      <li><a href="{{url('vendor/funeral')}}"><i class="fa fa-caret-right" aria-hidden="true"></i>Funeral </a></li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul id="vendor" class="collapse collapseItem">
                      <li><a href="{{$jenis}}/eventorganizer"><i class="fa fa-caret-right" aria-hidden="true"></i>Event Organizer </a></li>
                      <li><a href="{{$jenis}}/tabledecoration"><i class="fa fa-caret-right" aria-hidden="true"></i>Table Decoration </a></li>
                      <li><a href="{{$jenis}}/Photographer"><i class="fa fa-caret-right" aria-hidden="true"></i>Photographer </a></li>
                      <li><a href="{{$jenis}}/makeupartist"><i class="fa fa-caret-right" aria-hidden="true"></i>Make up Artist </a></li>
                    </ul>
                  </li>
                </ul>
              </div>
            ...
            <div class="col-md-6 col-lg-4">
              <div class="productBox">
                <div class="productImage clearfix">
                  <img src="{{ asset('img/vendor/'.$list->gambar1) }}" alt="products-img">
