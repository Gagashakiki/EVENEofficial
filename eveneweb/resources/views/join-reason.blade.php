  ...
  <section>
          ...
          <div class="d-flex wording">
            <div>
              <a data-toggle="modal" href="#signup-vendor">
                <button class="eveneBtn btn-outline-primary btn-lg">Sign Up</button>
              </a>
            </div>
            <div style="margin-left: 1rem">
              <a data-toggle="modal" href='.login-modal'>
                <button class="eveneBtn btn-outline-primary btn-lg">Sign In</button>
              </a>
            </div>
          </div>
        </div>
    ...
    <div id="what-section" class="container">
      <div class="d-flex flex-column justify-content-center align-items-center text-center wording-section">
        ...
        <h4 style="width:76%; word-spacing: .5rem" class="wording">It means there is something you have to improve in your business and profile. But don’t worry,
