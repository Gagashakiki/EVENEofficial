        ...
        <div class="col-md-6 col-12">
          <ul class="list-inline float-right top-right">
            @if(session()->has('profil')) @else <li class="account-login"><span><small class="text-warning"><a
                    href='{{ url('why-join-us#main-section') }}' class="text-warning" style="font-weight: bold">are you vendor ?</a></small> <a
...
{{--                      {{ csrf_field() }}--}}
{{--                      <input type="text" name="query" class="form-control" placeholder="Find your best EO.... Type All for everything"--}}
    ...
    <div class="container">
      ...
      <form class="form-inline navbar-brand" action="{{url('search')}}" method="get">
        ...
        <a class="mr-3" href="{{ url('/') }}">
          <img class="img-fluid" src="{{ asset('img/new-evene-logo.png') }}" width="100" height="100">
          {{-- <svg
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown megaDropMenu ">
            <a href="{{ url('inspiration') }}" class="nav-link">Inspirations</b></a>
          </li>
          <li class="nav-item dropdown megaDropMenu ">
            <a href="{{ url('blog') }}" class="nav-link">Blog</b></a>
          </li>
