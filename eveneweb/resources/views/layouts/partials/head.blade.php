    ...
    <title>Evene - Largest EO Market Place</title>
    ...
    <link href="{{ asset('plugins/iziToast/css/iziToast.css') }}" rel="stylesheet">
    <link href="{{ asset('plugins/prismjs/prism.css') }}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ asset('plugins/rs-plugin/css/settings.css') }}" media="screen">
    <link rel="stylesheet" type="text/css" href="{{ asset('plugins/slick/slick.css') }}" media="screen">
    <link rel="stylesheet" type="text/css" href="{{ asset('plugins/slick/slick-theme.css') }}" media="screen">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-162383283-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-162383283-1');
    </script>
