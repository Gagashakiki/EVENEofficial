...
@section('content')
  ...
  <section class="mainContent clearfix userProfile">
    <form action="{{url('/account/vendors/edit')}}" method="post" enctype="multipart/form-data">
      {{ csrf_field() }}
      <div class="container">
        <div class="row mb-5">
          <div class="col-12">
            ...
            <div class="innerWrapper singleOrder mb-3">
              ...
              @foreach($detail as $detail)
                <div class="form-group row">
                  ...
                  <div class="col-md-7">
                    <input type="text" value="{{$detail->nama}}" name="nama" class="form-control" id=""
                           placeholder="Celine Kesley" required>
                  </div>
                </div>
                ...
                <div class="col-12 mb-5">
                  <div class="btn-group" role="group" aria-label="...">
                    <button type="submit" class="checking btn btn-evene"><h5>Save Changes</h5></button>
                  </div>
                </div>
              @endforeach
            </div>
